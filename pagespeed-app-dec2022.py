...
with left_col: 
    if len(domains) == 0:
        ...
        opportunities_stat_plot.update_layout(margin=dict(l=50, r=50, t=10, b=200), plot_bgcolor='white')
...
with right_col:
    if len(domains) == 0:
        ...
        opportunities_dist_plot.update_layout(margin=dict(l=50, r=50, t=10, b=200), plot_bgcolor='white')
